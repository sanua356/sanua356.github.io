...
$(document).ready(function() {
	$("#hide-all-tours-btn").on("click", function() {
		...
		setTimeout('$(".shows-tours").addClass("hide");$("#hide-all-tours").addClass("hide");', 1000);
...
$(document).ready(function(){
	if ( $(".slick-active").hasClass("slide1") ) {
		$("#current-slide").empty()
		$('#current-slide').append("1");
	}
	else{}
	if ( $(".slick-active").hasClass("slide2") ) {
			$("#current-slide").empty()
			$('#current-slide').append("2");
		}
	else{}
	if ( $(".slick-active").hasClass("slide3") ) {
			$("#current-slide").empty()
			$('#current-slide').append("3");
		}
	else{}
});
